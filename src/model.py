...
class ClassificationNN():
    ...
    def __init__(self, project_name, target_size, augmentation_strength=0.1, preprocessing=None, batch_size=50, scale=65535):
        self.project_name = project_name
        self.target_size = target_size
        self.train_datagen = None
        self.train_generator= None
        self.validatin_datagen = None
    ...
    def build_generators(self):
        ...
        def fit(self, scale, train_path, val_path, hold_path):
